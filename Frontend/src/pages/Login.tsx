...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .auth-input {
    width:100%;
    padding:.72rem .72rem .72rem 2.6rem;
    background:#f9fafb;
  ...
  .auth-btn {
    width:100%;
    padding:.82rem;
    background:linear-gradient(135deg,#2463eb,#06d6f5);
    border:none;
    border-radius:10px;
    color:#fff;
    font-size:.95rem;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (msg.toLowerCase().includes("verify")) {
        ...
        setTimeout(() => navigate("/verify-otp", { state: { email: username } }), 1500);
      } else {
        setError(msg);
      }
    } finally {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="auth-fg">
              ...
              <div className="auth-iw">
                ...
                <input id="login-user" className="auth-input" type="text" placeholder="your_username" required value={username} onChange={e => setUsername(e.target.value)} />
              </div>
            </div>
            <div className="auth-fg">
              ...
              <div className="auth-iw">
                ...
                <input id="login-pass" className="auth-input" type={showPass ? "text" : "password"} placeholder="••••••••" required value={password} onChange={e => setPassword(e.target.value)} />
